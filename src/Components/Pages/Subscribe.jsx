...
// const Subscribe = () => {
//   return (
//     <div className="my-28 px-8 flex gap-10">
...
//         <h2 className="text-5xl font-bebas-neue">
//           Subscribe to our Newsletter
//         </h2>
//         <p className="text-xl">
//           Get the latest history news and content tailored to your interests.
//         </p>
//         <div className="flex mb-5">
//           <input
//             className="font-bold px-3 rounded-l-lg w-3/4 border-2 border-gray-100"
//             type="email"
//             name=""
//             placeholder="Email Address"
//           />
//           <button className="w-1/4 btn px-3 py-5 bg-[#A0153E] text-white hover:bg-pink-900 font-bold">
//             SIGN UP
//           </button>
//         </div>
//         <p>
//           Every week we'll send you the latest articles, videos, and podcasts
//           from the HistoryPress team straight into your inbox.
//         </p>
//       </div>
//     </div>
//   );
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center  gap-4 sm:gap-5 px-4 sm:px-6 md:px-10">
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-2 md:mb-3 lg:mb-5">
            <input
              ...
              placeholder="Email Address"
            />
            <button className="w-full md:w-2/5 lg:w-1/4 btn px-3 py-3  md:py-6 bg-[#A0153E] text-white hover:bg-pink-900 font-semibold lg:font-bold">
              SIGN UP
            </button>
          </div>
