  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col md:flex-row mt-6 sm:mt-8 md:mt-28 gap-6 sm:gap-8 md:gap-10">
        ...
        <div className="w-full md:w-1/2 hover:shadow-[4px_4px_0_0] rounded-lg hover:shadow-gray-200 hover:-translate-1 duration-500">
          <img
      ...
      {/* Our Vision */}
      <div className="flex flex-col md:flex-row mt-6 sm:mt-8 md:mt-28 gap-6 sm:gap-8 md:gap-10">
        <div className="w-full md:w-1/2 order-2 md:order-1 rounded-lg hover:shadow-gray-200 hover:-translate-1 duration-500">
          <img
            className="w-full rounded-lg"
          ...
          <Fade direction="right">
            ...
            <button className="flex justify-start">
              <a
                ...
                className="text-[16px] sm:text-[16px] md:text-[20px] lg:text-[22px] font-pacifico hover:text-pink-900"
      ...
      <div className="flex flex-col md:flex-row mt-6 sm:mt-24 md:mt-24 gap-6 sm:gap-6 md:gap-10">
        <div className="w-full md:w-1/2 flex flex-col justify-center gap-4 sm:gap-4 md:gap-6 px-0 lg:px-14">
          <Fade direction="left">
            ...
            <p className=" text-sm sm:text-base md:text-[18px]">
              ...
              community by designing programs that inspire, challenge, educate
              and entertain.
            </p>
            <button className="flex justify-start">
              <a
                ...
                className="text-lg sm:text-xl md:text-[22px] font-pacifico hover:text-pink-900"
                rel="noopener noreferrer"
              >
                See more here
              </a>
        ...
        <div className="w-full md:w-1/2  rounded-lg hover:shadow-gray-200 hover:-translate-1 duration-500">
          <img
            className="w-full rounded-lg"
